...
yay -S --noconfirm  ufw clamtk firefox discord onedriver vlc xow-git alacritty libreoffice-fresh-es lutris steam wine heroic-games-launcher-bin gparted mc nano && \
