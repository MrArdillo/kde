...
yay -S --noconfirm ufw clamtk piper firefox-i18n-es-es discord onedriver ttf-ms-fonts libreoffice-fresh-es okular flatpak vlc xone-dkms lutris steam wine heroic-games-launcher-bin gparted mc nano && \
