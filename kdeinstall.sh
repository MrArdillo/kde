...
yay -S --noconfirm libpamac-nosnap pamac-nosnap ufw clamtk firefox-i18n-es-es discord onedriver libreoffice-fresh-es okular flatpak vlc xow-git alacritty lutris steam wine heroic-games-launcher-bin gparted mc nano && \
