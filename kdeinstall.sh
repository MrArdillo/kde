...
yay -S --noconfirm ufw clamtk debtap firefox-i18n-es-es discord onedriver ttf-ms-fonts libreoffice-fresh-es okular flatpak vlc lutris steam wine heroic-games-launcher-bin gparted mc nano && \
