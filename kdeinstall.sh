...
yay -S --noconfirm ufw clamtk debtap firefox-i18n-es-es discord onedriver ttf-ms-win11 ttf-arphic-ukai ttf-arphic-uming libreoffice-fresh-es okular flatpak xone-dkms-git vlc lutris steam wine heroic-games-launcher-bin gparted mc nano && \
