...
yay -S --noconfirm ufw clamtk firefox-i18n-es-es discord onedriver ttf-ms-fonts libreoffice-fresh-es okular flatpak vlc xone-dkms xow-git lutris steam wine heroic-games-launcher-bin gparted mc nano && \
